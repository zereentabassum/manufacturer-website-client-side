...
const Footer = () => {
    return (
        <div className=' bg-gradient-to-r from-purple-200 to-accent'>
            <footer className="footer p-10  text-base-content text-base">
  <div>
...
<footer className="footer px-2 py-4 border-t  bg-gradient-to-r from-purple-200 to-accent text-base-content border-base-300 ">
