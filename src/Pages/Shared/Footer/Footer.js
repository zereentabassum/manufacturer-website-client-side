...
const Footer = () => {
    return (
        <div className=' bg-gradient-to-r from-neutral to-accent'>
...
<footer className="footer px-10 py-4 border-t  bg-gradient-to-r from-neutral to-accent text-base-content border-base-300 ">
